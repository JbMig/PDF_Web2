...
export default function ChangeSettings({ props }: { props: ChangeSettingsPopupInterface }) {
        ...
        <>
            ...
            <div className="modal" id="change_settings">
                <div className="modal-box bg-gray_border">
                    <div className="flex">
                        <p className="font-bold text-xl flex-1 text-white mb-md">Change settings</p>
                        <a href="" className="font-bold text-white">✕</a>
                    </div>
                    ...
                    >
                        ...
                        <input type="number" min="0" max="30" placeholder="Enter new value" className="input"/>
                    </form>
