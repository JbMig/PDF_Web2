...
export default function SubHeaderTitle({ props }: { props: SubHeaderTitleInterface }) {
	...
	const spanClassName = "font-sans self-center text-medium font-bold text-white";
	const linkClassName = "font-sans self-center text-medium font-bold text-white hover:text-main_yellow";
	let title_complete;
