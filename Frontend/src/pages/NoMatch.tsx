...
export default function NoMatch() {
  return (
    <div
      className={
        'mx-auto flex h-full max-w-[1440px] items-center justify-between px-base pb-[50px] pt-[200px] max-xl:flex-col-reverse max-xl:justify-center max-sm:justify-end max-sm:pt-[300px]'
      }
    >
      <div>
        <h2
